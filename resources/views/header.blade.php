<div id="header">
        ...
        <div class="container">
            ...
            <div class="pull-right auto-width-right">
                ...
                <ul class="top-details menu-beta l-inline">
                    <li><a href="{{ url('/admin/')}}"><i class="fa fa-user"></i>@if(Session::has('name')) {{Session::get('name')}} @else Tài khoản @endif</a></li>
    ...
    <div class="header-body">
        <div class="container beta-relative">
            <div class="pull-left">
                <a href="{{ url('/index/') }}" id="logo"><img src="public/source/assets/dest/images/logo-cake.png" width="200px" alt=""></a>
            </div>
                ...
                <div class="beta-comp">
                    ...
                    <div class="cart">
                        ...
                        @foreach($product_cart as $product)
                            <div class="cart-item">
                                <a class="cart-item-delete" href="{{url('delete-cart',$product['item']['id'])}}"><i class="fa fa-times"></i></a>
                                <div class="media">
