		...
		<div id="content">
				...
				<div class="history-slider">
					...
					<div class="history-slides">
						<div>
							<div class="row">
							<div class="col-sm-5">
								<img src="public/source/assets/dest/images/history.jpg" alt="">
							</div>
							<div class="col-sm-7">
			...
			<div class="row">
				<div class="col-sm-6 wow fadeInLeft">
					<div class="beta-person media">
						...
						<img class="pull-left" src="public/source/assets/dest/images/person2.jpg" alt="">
				...
				<div class="col-sm-6 wow fadeInRight">
					<div class="beta-person media ">
						...
						<img class="pull-left" src="public/source/assets/dest/images/person3.jpg" alt="">
			...
			<div class="row">
				...
				<div class="bets-img-hover">
						<img src="public/source/assets/dest/images/person1.jpg" alt="">
				</div>
				...
				<div class="col-sm-3">
					<div class="beta-person beta-person-full">
					<div class="bets-img-hover">
						<img src="public/source/assets/dest/images/person2.jpg" alt="">
					</div>
						<div class="beta-person-body">
							<h5>Bob Robertson</h5>
							<p class="font-large">Web developer</p>
				...
				<div class="col-sm-3">
					<div class="beta-person beta-person-full">
					<div class="bets-img-hover">
						<img src="public/source/assets/dest/images/person3.jpg" alt="">
					</div>
						<div class="beta-person-body">
							<h5>Mike Greenwood</h5>
							<p class="font-large">Web developer</p>
				...
				<div class="col-sm-3">
					<div class="beta-person beta-person-full">
					<div class="bets-img-hover">
						<img src="public/source/assets/dest/images/person4.jpg" alt="">
					</div>
						<div class="beta-person-body">
							<h5>David Black</h5>
							<p class="font-large">Web developer</p>
