							...
							<div class="col-sm-4">
								<div class="single-item">
									...
									<div class="single-item-header">
										<a href="{{route('chitietsanpham',$sp->id)}}"><img src="public/source/image/product/{{$sp->image}}" alt="" height="250px"></a>
									</div>
									...
									<div class="single-item-caption">
										<a class="add-to-cart pull-left" href="{{ url('add-to-cart',$sp->id) }}"><i class="fa fa-shopping-cart"></i></a>
										<a class="beta-btn primary" href="{{ url('chi-tiet-san-pham',$sp->id) }}">Details <i class="fa fa-chevron-right"></i></a>
										<div class="clearfix"></div>
									</div>
								</div>
							</div>
						...
						@foreach($sp_khac as $sp_k)
							<div class="col-sm-4">
								<div class="single-item">
									...
									@endif
									<div class="single-item-header">
										<a href="product.html"><img src="public/source/image/product/{{$sp_k->image}}" alt="" height="250px"></a>
									</div>
									<div class="single-item-body">
									...
									<div class="single-item-caption">
										<a class="add-to-cart pull-left" href="{{ url('add-to-cart',$sp_k->id) }}"><i class="fa fa-shopping-cart"></i></a>
										<a class="beta-btn primary" href="{{ url('chi-tiet-san-pham',$sp_k->id) }}">Details <i class="fa fa-chevron-right"></i></a>
										<div class="clearfix"></div>
									</div>
								</div>
							</div>
